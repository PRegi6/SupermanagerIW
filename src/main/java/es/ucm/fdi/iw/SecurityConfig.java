	...
	protected void configure(HttpSecurity http) throws Exception {
	    http
	        ...
	        .authorizeRequests()
	            ...
	            .antMatchers("/user/**", "/clasificacion", "/equipos", "/mercado", "/actualidad", "/miequipo", "/jugador", "/liga", "/crearliga").hasRole("USER")	   // <-- logged-in users
				.antMatchers("/").authenticated() // Requiere autenticación para la página principal
